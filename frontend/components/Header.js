...
export default function Header() {
  return (
    <div className="px-8 py-5 bg-white shadow-md flex items-center">
      ...
      <div className="flex items-center flex-grow bg-gray-100 mx-10 md:mx-20 rounded-lg py-2 text-gray-700 text-base">
